...
export default function PortalLogin() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-[#FAF8F2] text-[#14110B] px-5 font-sans">
      <div className="w-full max-w-[400px]">
        ...
        <form onSubmit={submit} className="bg-white border border-[#E9E3D6] rounded-2xl p-7 shadow-[0_12px_40px_rgba(20,17,11,0.06)]">
          ...
          <p className="text-[13px] text-[#6b6455] mb-5">Employees &amp; owner — apni earning aur commissions dekhne ke liye.</p>

          <label className="block text-[12px] font-medium text-[#3a352b] mb-1.5">Email</label>
          <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="email"
            className="w-full text-[14px] border border-[#E2DBCB] rounded-[10px] px-3 py-2.5 outline-none focus:border-[#C6A249] focus:ring-2 focus:ring-[#C6A249]/20 mb-4" />
